                ...
                <form class="form-horizontal m-t-30" method="POST" action="Leave">
                    ...
                    <div class="form-group" style = "margin-top: -84.5px; margin-left: 50%">
                        ...
                        <input id="lastname" type="text" style = "width: 100%;" class="form-control @error('email') is-invalid @enderror"
                            name="designation" value="{{ old('lastname') }}" required autocomplete="lastname" autofocus>
                    ...
                    <div class="form-group" style="margin-top: 21px;">
                        ...
                        <select name="dept" id="Typ_leave" style = "width: 47%; height: 35px;" 
                    ...
                    <div class="form-group" style = "margin-top: -87px; margin-left: 50%">
                        ...
                        <select name="branch" id="Typ_leave" style = "width: 100%; height: 35px;" 
                            value="" required autocomplete="email" autofocus>
                            <option>Annual</option>
                            <option>Casual</option>
                            <option>Compassionate</option>
                    ...
                    <div class="form-group" style = "margin-top: -84.5px; margin-left: 63%" >
                        ...
                        <select name="lvtype" id="Typ_leave" style = "width: 100%; height: 35px;" 
                    ...
                    <div class="form-group" style = "margin-top: -87px; margin-left: 50%">
                        ...
                        <select name="rlv" id="Typ_leave" style = "width: 100%; height: 35px;" 
                            name="email" value="" required autocomplete="email" autofocus>
                            <option>Annual</option>
                            <option>Casual</option>
                            <option>Compassionate</option>
